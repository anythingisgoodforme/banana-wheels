(function initLessons(root, factory) {
  ...
  const LESSONS = [
    ...
    },
    {
      ...
      prompt: 'Build the mixed-up riff in the four slots, then press Check.',
      explanation:
    ...
    },
    {
      ...
      prompt: 'Build the whole bassline in order, then press Check bassline.',
      explanation:
    ...
    },
    {
      ...
      example:
        "Warm up, review E/A notes, clap the rhythm, play one riff, then choose tomorrow's goal.",
    ...
    },
    {
      ...
      song: {
        title: 'Banana Walk',
        feel: 'Two-bar rock groove',
        sections: [
          { label: 'Bar 1', beats: 'E G A B' },
          { label: 'Bar 2', beats: 'D E G A' },
          { label: 'Bar 3', beats: 'B A G E' },
          { label: 'Bar 4', beats: 'D E G A' },
        ],
      },
      targets: [
        { label: 'Bar 1 beat 1', answer: 'E', stringId: 'E', fret: 0 },
        { label: 'Bar 1 beat 2', answer: 'G', stringId: 'E', fret: 3 },
        { label: 'Bar 1 beat 3', answer: 'A', stringId: 'A', fret: 0 },
        { label: 'Bar 1 beat 4', answer: 'B', stringId: 'A', fret: 2 },
        { label: 'Bar 2 beat 1', answer: 'D', stringId: 'D', fret: 0 },
        { label: 'Bar 2 beat 2', answer: 'E', stringId: 'D', fret: 2 },
        { label: 'Bar 2 beat 3', answer: 'G', stringId: 'E', fret: 3 },
        { label: 'Bar 2 beat 4', answer: 'A', stringId: 'A', fret: 0 },
        { label: 'Bar 3 beat 1', answer: 'B', stringId: 'A', fret: 2 },
        { label: 'Bar 3 beat 2', answer: 'A', stringId: 'A', fret: 0 },
        { label: 'Bar 3 beat 3', answer: 'G', stringId: 'E', fret: 3 },
        { label: 'Bar 3 beat 4', answer: 'E', stringId: 'E', fret: 0 },
        { label: 'Bar 4 beat 1', answer: 'D', stringId: 'D', fret: 0 },
        { label: 'Bar 4 beat 2', answer: 'E', stringId: 'D', fret: 2 },
        { label: 'Bar 4 beat 3', answer: 'G', stringId: 'E', fret: 3 },
        { label: 'Bar 4 beat 4', answer: 'A', stringId: 'A', fret: 0 },
      ],
